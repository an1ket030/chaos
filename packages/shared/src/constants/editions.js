...
exports.DEFAULT_EDITION = exports.EDITIONS = void 0;
...
exports.DEFAULT_EDITION = 'world-cup';
function getEdition(slug) {
    return exports.EDITIONS.find((e) => e.slug === slug) ?? exports.EDITIONS[exports.EDITIONS.length - 1];
}
